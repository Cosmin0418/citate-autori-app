export default function QuoteCard({ quote, onEdit, onDelete }) {
  return (
    <div className="flex flex-col justify-between bg-white rounded-2xl shadow-md border hover:shadow-lg transition-shadow duration-300 p-6 border-gray-100">
      {/* Zona textului */}
      ...
      {/* Butoanele de administrare (Apar doar când e nevoie) */}
      {(onEdit || onDelete) && (
