...
const Joi = require("joi"); // Am adaugat Joi
const app = express();
...
// Middleware: Verificam daca ID-ul din PUT si DELETE este un numar valid
...
// Adaugam un nou citat (POST)
app.post("/api/quotes", async (req, res) => {
  // Validam datele primite inainte de a merge mai departe
...
// Actualizam un citat (PUT) - Folosim validateId si Joi
...
// Stergem un citat (DELETE) - Folosim validateId
